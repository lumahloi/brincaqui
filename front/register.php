...
<body>
  <form id="register-form">
    ...
    <div class="mb-3">
      ...
      <input type="password" class="form-control" id="form-password" placeholder="Sua senha">
    </div>
    <div class="mb-3">
      <label for="form-confirm-password" class="form-label">Confirme sua senha</label>
      <input type="password" class="form-control" id="form-confirm-password" placeholder="Confirme sua senha">
    </div>
