...
INSERT INTO Comodidade (com_title, com_creation, com_active, com_latedit) VALUES
  ...
  ('Atividades Sensoriais', CURDATE(), 1, CURDATE()),
  ('Monitoramento por Câmeras', CURDATE(), 1, CURDATE()),
  ('Piso Emborrachado Antialérgico', CURDATE(), 1, CURDATE()),
  ...
  ('Micro-ondas Disponível', CURDATE(), 1, CURDATE()),
