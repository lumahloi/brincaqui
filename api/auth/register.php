...
switch ($_SERVER['REQUEST_METHOD'])
{
  case 'POST': 
    ...
    $input_fullname = filter_input(INPUT_POST, "fullname");
    $input_email = filter_input(INPUT_POST, "email");
    $input_telephone = filter_input(INPUT_POST, "telephone");
    $input_password = filter_input(INPUT_POST, "password");
    $input_confirm_password = filter_input(INPUT_POST, "confirmPassword");
    $input_user_type = filter_input(INPUT_POST, "userType");
